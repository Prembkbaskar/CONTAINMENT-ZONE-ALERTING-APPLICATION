from flask import Flask, render_template, request, redirect, url_for, session,mysql
import ibm_db
import re
...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:31321 ;PORT=31321;SECURITY=SSL;SSLServerCertificate=Certificate.crt;UID=jcy60233;PWD=DXUUVgP7PExNkbLi",'','')
